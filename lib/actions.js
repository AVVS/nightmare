...
exports.visible = function(selector, done) {
  debug('.visible() for %j', selector);
  this.evaluate_now(function(selector) {
    var elem = __nightmare.qs(selector);
...
exports.exists = function(selector, done) {
  debug('.exists() for %j', selector);
  this.evaluate_now(function(selector) {
    return (__nightmare.qs(selector)!==null);
  }, done, selector);
};
...
exports.click = function(selector, done) {
  debug('.click() on %j', selector);
  this.evaluate_now(function (selector) {
    document.activeElement.blur();
    var element = __nightmare.qs(selector);
    if (!element) {
...
exports.type = function() {
  ...
  debug('.type() %s into %j', text, selector);
  var self = this;
...
exports.insert = function(selector, text, done) {
  ...
  debug('.insert() %s into %j', text, selector);
...
function waitelem (self, selector, done) {
  eval("var elementPresent = function() {"+
      "  var element = __nightmare.qs('"+jsesc(selector)+"');"+
